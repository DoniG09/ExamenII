...
namespace POO.Vista
{
    ...
    public partial class TiposSoporte : Form
    {
        ...
        public TiposSoporte()
        {
            ...
            InitializeComponent();
            TipoSoporteController controlador = new TipoSoporteController(this); //this hace referencia al formulario actual
        ...
        //{
        //    //dataGridViewTicketsGenerados.DataSource = usuarioDAO.GetUsuarios();
        //}
